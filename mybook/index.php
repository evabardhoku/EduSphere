		...
		<div style="width: 800px;margin:auto;min-height: 400px;">
			...
			<div style="display: flex;">	
				...
				<div style="min-height: 400px;flex:1;">
					...
					<img id="profile_pic" src="<?php echo $image  ?>"><br><br>

						<a href="profile.php" style="text-decoration: none;">
						 <?php echo $user_data['first_name'] . "<br> " . $user_data['last_name']?> <br>
                         <?php   echo "<span style='color: " . ($online_status == "Online" ? "green" : "red") . "; font-weight: bold;'>" . $online_status . "</span>"; ?>
						</a><br>
