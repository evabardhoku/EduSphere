var mycomment = {
    ...
    next_page: function () {
        ...
        awindow.location.href = 'index.php?page=' + mycomment.page_number;
    },

    prev_page: function () {
        mycomment.page_number = mycomment.page_number - 1;
        if (mycomment.page_number < 1)              //if user wants to pass down the first page it will show again that first page
