                ...
                if(obj.success){
                    ...
                    if(typeof obj.rows == 'object'){
                        ...
                        for (var i = 0; i < obj.rows.length; i++) {
                            ...
                            template.querySelector(".js-profile-link").href = (typeof obj.rows[i].user == 'object') ? 'users_profile.php?id=' + obj.rows[i].user.id : '#';
...
next_page: function(){
    ...
    mypost.load_posts();
    document.querySelector(".js-page-number").innerHTML = "Page " + mypost.page_number;awindow.location.href = 'index.php?page=' + mypost.page_number;
},

prev_page: function(){
    mypost.page_number = mypost.page_number - 1;
    if(mypost.page_number < 1)              //if user wants to pass down the first page it will show again that first page
