        ...
        $info['success'] = true;
                    ...
                    if ($_POST['data_type'] == 'login') {
                        ...
                        if ($_POST['data_type'] == 'logout') {
                            ...
                            $query = "UPDATE posts SET post = '$post', date = '$date' WHERE id = '$id' AND user_id = '$user_id' LIMIT 1";
                            query($query);

                            if (mysqli_affected_rows($con) > 0) {
                                $info['success'] = true;
                                $info['message'] = "Your post was updated successfully";
                            } else {
                                $info['message'] = "Could not update the post. Please try again.";
                            }
